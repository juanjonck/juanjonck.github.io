...
<html>
    <head>
        ...
        <title>Juan Jonck - Portfolio</title>
    ...
    <body>
                ...
                <div class="content first-content">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-9">
                            <h2>Juan Jonck</h2>
                            <p>
                                PHP - Laravel - CodeIgniter - MySQL - Bootstrap - CSS - HTML - JavaScript - jQuery
                            </p>
                            <div class="main-btn"><a href="#2">Read More</a></div>
                            <div class="cv-btn"><a href="#" target="_blank">Download CV</a></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="col-md-6">
                            <div class="left-content">
                                <h2>About Me</h2>
                                <p>I am a seasoned full-stack PHP developer based in the picturesque city of Cape Town, South Africa. </p>
                                <p>Proficient in PHP, with hands-on experience in Laravel and CodeIgniter frameworks, I specialize in crafting dynamic web solutions. My skill set extends to HTML, CSS, Bootstrap, and the dynamic duo of JavaScript and jQuery.</p>
                                <p>Beyond the digital realm, I find joy in various hobbies.
                                Online gaming is not just a pastime but a passion, where I immerse myself in virtual worlds.
                                Fishing provides a serene escape, allowing me to connect with nature and relish the tranquility it offers.
                                Additionally, I have a flair for culinary creativity and enjoy experimenting with diverse ingredients to whip up delicious dishes.
                                Combining technical expertise with a diverse set of interests, I am dedicated to bringing innovation and quality to every web development project.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="first-section">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="left-content">
                                                    <h2>PHP: A Time-Tested Titan in the World of Programming Languages</h2>
                                                    <p>In the ever-evolving landscape of programming languages, some stalwarts continue to stand the test of time. PHP, originally designed for web development, has consistently proven its versatility, reliability, and efficiency. Despite the emergence of new languages, PHP remains a formidable choice for developers worldwide.</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="right-content">
                                                    <h2>The Power of Custom Web Development: Tailoring Your Digital Presence for Success</h2>
                                                    <p>In the dynamic and competitive online landscape, having a unique and engaging web presence is crucial for businesses and individuals alike. While template and theme-based solutions offer a quick start, custom web development emerges as the superior choice for those aiming for unparalleled functionality, aesthetics, and brand identity.</p>
                                                    <div class="main-btn"><a href="#4">Continue Reading</a></div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="footer">
            <div class="content">
                <p>Copyright &copy; <?php echo date('Y'); ?> Juan Jonck</p>
            </div>
        </div>
